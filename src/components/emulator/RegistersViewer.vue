      ...
      return [
        {
          ...
          content: formatNumber(
            this.registers[CsRegisterName.R0],
        ...
        },
        {
          name: 'R1',
          content: formatNumber(
            this.registers[CsRegisterName.R1],
            this.displayableRadix,
            8,
            prefix
          ),
        },
        {
          name: 'R2',
          content: formatNumber(
            this.registers[CsRegisterName.R2],
            this.displayableRadix,
            8,
            prefix
          ),
        },
        {
          name: 'R3',
          content: formatNumber(
            this.registers[CsRegisterName.R3],
            this.displayableRadix,
            8,
            prefix
          ),
        },
        {
          name: 'R4',
          content: formatNumber(
            this.registers[CsRegisterName.R4],
            this.displayableRadix,
            8,
            prefix
          ),
        },
        {
          name: 'R5',
          content: formatNumber(
            this.registers[CsRegisterName.R5],
            this.displayableRadix,
            8,
            prefix
          ),
        },
        {
          name: 'R6',
          content: formatNumber(
            this.registers[CsRegisterName.R6],
            this.displayableRadix,
            8,
            prefix
          ),
        },
        {
          name: 'R7',
          content: formatNumber(
            this.registers[CsRegisterName.R7],
            this.displayableRadix,
            8,
            prefix
          ),
        },
        {
          name: 'PC',
          content: formatNumber(
            this.registers[CsRegisterName.PC],
            this.displayableRadix,
            8,
            prefix
          ),
        },
        {
          name: 'SP',
          content: formatNumber(
            this.registers[CsRegisterName.SP],
            this.displayableRadix,
            8,
            prefix
          ),
        ...
        },
        {
          name: 'AC',
          content: formatNumber(
            this.registers[CsRegisterName.AC],
            this.displayableRadix,
            8,
            prefix
          ),
        ...
        },
        {
          name: 'MDR',
          content: formatNumber(
            this.registers[CsRegisterName.MDR],
            this.displayableRadix,
            8,
            prefix
          ),
        },
        {
          name: 'MAR',
          content: formatNumber(
            this.registers[CsRegisterName.MAR],
            this.displayableRadix,
            8,
            prefix
          ),
