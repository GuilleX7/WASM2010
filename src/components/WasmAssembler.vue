  ...
  <div class="is-fullwidth is-viewheight">
    ...
    <div class="is-flex is-flex-direction-column is-fullheight">
      <div class="asm--assembler-menu">
        ...
        <template v-if="!isRunningEmulation">
          <b-dropdown>
            ...
            <b-dropdown-item @click="showNewFileDialog">
              New
            </b-dropdown-item>
      ...
      <div
        ...
        class="asm--assembler-editor"
      >
        <div
          ref="sourceMetadataContainer"
          class="asm--assembler-code-metadata"
        >
          <div
            v-for="(
      ...
      >
        ...
        >
          <span
            v-if="isAssemblyPending"
            class="bulma-loader-mixin mr-3"
          />
