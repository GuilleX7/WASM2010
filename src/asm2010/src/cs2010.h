 ...
 * @param cs Pointer to the CS2010 structure
 */
__attribute__((visibility("default"))) void cs_hard_reset(cs2010 *cs);
...
cs_load_and_check(cs2010 *cs, unsigned short *sentences,
 ...
 * @param cs Pointer to the CS2010 structure
 */
__attribute__((visibility("default"))) void cs_fetch(cs2010 *cs);
 ...
 * @param cs Pointer to the CS2010 structure
 */
__attribute__((visibility("default"))) void cs_free(cs2010 *cs);
